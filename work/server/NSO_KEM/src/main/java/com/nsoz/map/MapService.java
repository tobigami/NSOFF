    ...
    public void playerMove(Char p) {
        try {
            ...
            mss.cleanup();
             ...
             Log.logException("player move err: " , MapService.class, ex);
        }
    }
    /// dev fix bug lôi đài 13/8
    public void sendEndMp(Char _char) {
        try {
            Message ms = messageSubCommand(-121);
            DataOutputStream ds = ms.writer();
            ds.writeInt(_char.mp);
            ds.flush();
            sendMessage(ms);
            _char.serverMessage("Không đủ MP để sử dụng");
        } catch (IOException e) {
    ...
    public void moveOutClan(Char p) {
        try {
            ...
            ms.cleanup();
             ...
             Log.logException("moveOutClan err: " , MapService.class, ex);
        }
    }
        ...
        if (clan != null) {
            try {
                ...
                ms.cleanup();
                 ...
                 Log.logException("acceptInviteClan err: " , MapService.class, ex);
            }
        }
    }
    ...
    public void removeItem(short itemID) {
        try {
            ...
            sendMessage(ms);
             ...
             Log.logException("removeitem err: " , MapService.class, ex);
        }
    }
    ...
    public void recoveryMonster(Mob mob) {
        try {
            ...
            m.cleanup();
             ...
             Log.logException("recovery monster err: " , MapService.class, ex);
        }
    }
    ...
    public void sendTimeInMap(int timeCountDown) {
        try {
            ...
            ms.cleanup();
             ...
             Log.logException("sendTimeInMap err: " , MapService.class, ex);
        }
    }
    ...
    public void addMob(Mob mob) {
        try {
            ...
            sendMessage(mss);
             ...
             Log.logException("add mob err: " , MapService.class, ex);
        }
    }
    ...
    public void refreshHP(Char p) {
        try {
            ...
            ms.cleanup();
             ...
             Log.logException("refresh hp err: " , MapService.class, ex);
        }
    }
    ...
    public void addItemMap(ItemMap itemMap) {
        try {
            ...
            m.cleanup();
             ...
             Log.logException("add item err: " , MapService.class, ex);
        }
    }
    ...
    public void playerAddEffect(Char _char, Effect effect) {
        try {
            ...
            ms.cleanup();
             ...
             Log.logException("add effect err: " , MapService.class, ex);
        }
    }
    ...
    public void playerRemoveEffect(Char _char, Effect effect) {
        try {
            ...
            ms.cleanup();
             ...
             Log.logException("remove eff err: " , MapService.class, ex);
        }
    }
    ...
    public void playerEditEffect(Char _char, Effect effect) {
        try {
            ...
            ms.cleanup();
             ...
             Log.logException("edit effect err: " , MapService.class, ex);
        }
    }
    ...
    public void loadLevel(Char _char) {
        try {
            ...
            ms.cleanup();
             ...
             Log.logException("load level err: " , MapService.class, ex);
        }
    }
    ...
    public void chat(int id, String text) {
        try {
            ...
            mss.cleanup();
             ...
             Log.logException("chat err: " , MapService.class, ex);
        }
    }
    ...
    public void removeBuNhin(int index) {
        try {
            ...
            ms.cleanup();
             ...
             Log.logException("remove bu nhin err: " , MapService.class, ex);
        }
    }
    ...
    public void attackMonster(int damage, boolean flag, Mob mob) {
        try {
            if (mob.isDead) {
             ...
             Log.logException("attack npc err: " , MapService.class, ex);
        }
    }
    ...
    public void attackCharacter(int damage, int dameMp, Char _char) {
        try {
            ...
            sendMessage(mss);
             ...
             Log.logException("attack player err: " , MapService.class, ex);
        }
    }
    ...
    public void setSkillPaint_1(ArrayList<Mob> mobs, Char _char, byte skillId) {
        try {
            ...
            mss.cleanup();
             ...
             Log.logException("skill paint 1 err: " , MapService.class, ex);
        }
    }
    ...
    public void setSkillPaint_2(ArrayList<Char> chars, Char _char, byte skillId) {
        try {
            ...
            mss.cleanup();
             ...
             Log.logException("skill paint 2 err: " , MapService.class, ex);
        }
    }
    ...
    public void setFire(Mob mob) {
        try {
            ...
            ms.cleanup();
             ...
             Log.logException("set fire err: " , MapService.class, ex);
        }
    }
    ...
    public void setIce(Mob mob) {
        try {
            ...
            ms.cleanup();
             ...
             Log.logException("set ice err: " , MapService.class, ex);
        }
    }
    ...
    public void setWind(Mob mob) {
        try {
            ...
            ms.cleanup();
             ...
             Log.logException("set wind err: " , MapService.class, ex);
        }
    }
    ...
    public void setMove(Mob mob) {
        try {
            ...
            ms.cleanup();
             ...
             Log.logException("set don't move err: " , MapService.class, ex);
        }
    }
    ...
    public void setDisable(Mob mob) {
        try {
            ...
            ms.cleanup();
             ...
             Log.logException("set disable err: " , MapService.class, ex);
        }
    }
    ...
    public void loadMount(Char _char) {
        try {
            ...
            ms.cleanup();
             ...
             Log.logException("load mount err: " , MapService.class, ex);
        }
    }
    ...
    public void loadMask(Char _char) {
        try {
            ...
            ms.cleanup();
             ...
             Log.logException("load mask err: " , MapService.class, ex);
        }
    }
    ...
    public void loadHP(Char _char) {
        try {
            ...
            ms.cleanup();
             ...
             Log.logException("load HP err: " , MapService.class, ex);
        }
    }
    ...
    public void loadPant(Char _char) {
        try {
            ...
            sendMessage(ms);
             ...
             Log.logException("load pant err: " , MapService.class, ex);
        }
    }
    ...
    public void loadShirt(Char _char) {
        try {
            ...
            sendMessage(ms);
             ...
             Log.logException("load shirt err: " , MapService.class, ex);
        }
    }
    ...
    public void loadWeapon(Char _char) {
        try {
            ...
            sendMessage(ms);
             ...
             Log.logException("load wp err: " , MapService.class, ex);
        }
    }
    ...
    public void teleport(Char p) {
        try {
            ...
            mss.cleanup();
             ...
             Log.logException("teleport err: " , MapService.class, ex);
        }
    }
    ...
    public void mobMeAttack(Char _c, Object target) {
        ...
        try {
            ...
            sendMessage(ms);
             ...
             Log.logException("mob me err: " , MapService.class, ex);
        }
    }
    ...
    public void createBuNhin(Figurehead buNhin) {
        try {
            ...
            ms.cleanup();
             ...
             Log.logException("create bunhin err: " , MapService.class, ex);
        }
    }
    ...
    public void updateInfoChar(Char pl) {
        try {
            ...
            ms.cleanup();
             ...
             Log.logException("update info char err: " , MapService.class, ex);
        }
    }
    ...
    public void addEffect(Object obj, int id, int timeLive, int wait, int dy) {
        try {
            ...
            ms.cleanup();
             ...
             Log.logException("add eff err: " , MapService.class, ex);
        }
    }
    ...
    public void testAccept(int playerId, int playerId2) {
        ...
        try {
            ...
            sendMessage(msg);
             ...
             Log.logException("test accept err: " , MapService.class, ex);
        } finally {
            if (msg != null) {
                msg.cleanup();
            }
    ...
    public void npcUpdate(Npc npc) {
        try {
            ...
            ms.cleanup();
             ...
             Log.logException("npc update err: " , MapService.class, ex);
        }
    }
    ...
    public void testEnd(int playerId, int playerId2, int hp) {
        ...
        try {
            ...
            sendMessage(msg);
             ...
             Log.logException("test end err: " , MapService.class, ex);
        } finally {
            if (msg != null) {
                msg.cleanup();
            }
    ...
    public void returnPointMap(Char p) {
        try {
            ...
            mss.cleanup();
             ...
             Log.logException("return point map err: " , MapService.class, ex);
        }
    }
    ...
    public void npcChange(Mob mob) {
        try {
            ...
            msg.cleanup();
             ...
             Log.logException("npc change err: " , MapService.class, ex);
        }
    }
    ...
    public void waitToDie(Char p) {
        try {
            ...
            sendMessage(mss);
             ...
             Log.logException("waitToDie err: " , MapService.class, ex);
        }
    }
    ...
    public void callEffectNpc(Mob mob) {
        try {
            ...
            ms.cleanup();
             ...
             Log.logException("callEffectNpc err: " , MapService.class, ex);
        }
    }
    ...
    public void npcAttackPlayer(Mob mob, Char _char) {
        try {
            ...
            ms.cleanup();
             ...
             Log.logException("npc attack player err: " , MapService.class, ex);
        }
    }
    ...
    public void npcAttackBuNhin(Mob mob, int index) {
        try {
            ...
            ms.cleanup();
             ...
             Log.logException("npc attack bunhin err: " , MapService.class, ex);
        }
    }
