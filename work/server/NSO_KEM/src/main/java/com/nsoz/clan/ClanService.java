...
public class ClanService extends AbsService {
    ...
    public void chat(String name, String text) {
        try {
            ...
            mss.cleanup();
             ...
             Log.logException("chat err: " , ClanService.class, ex);
        }
    }
    ...
    public void requestClanInfo() {
        try {
            ...
            Log.logException("Lỗi tại requestClanInfo()",ClanService.class,ex);
        }
    }
    ...
    public void requestClanMember() {
        try {
            ...
            Log.logException("Lỗi tại requestClanMember()",ClanService.class,ex);
        }
    }
    ...
    public void requestClanItem() {
        try {
            ...
            Log.logException("Lỗi tại requestClanItem()",ClanService.class,ex);
        }
    }
    ...
    public void writeLog() {
        try {
            ...
            Log.logException("Lỗi tại requestClanWriteLog()",ClanService.class,ex);
        }
    }
