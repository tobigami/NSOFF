        ...
        if (_char.zone.tilemap.id == 167 && _char.zone.getLivingMonsters().isEmpty()) {
            if (_char.zone.isLastBossWasBorn) {
                ...
                try {
                    ...
                    Log.logException(String.format("Error finish on char name %s | Is null: %b", _char.name, ter == null), Territory.class, e);
        ...
        try {
            for (Char _char : members) {
                try {
                    ...
                    Log.logException("waitForNextTurn() lỗi (1)", Territory.class, e);
            ...
            Log.logException("waitForNextTurn() lỗi (2)", Territory.class, e);
        ...
        try {
            for (Char _char : members) {
                try {
                    ...
                    Log.logException("nextTurn() lỗi (1)", Territory.class, e);
                }
            }
            this.nextMapId = -1;
            this.countDown = 1800;
            ...
            Log.logException("nextTurn() lỗi (2)", Territory.class, e);
    ...
    public void finish() {
        ...
        for (Char _char : members) {
            try {
                ...
                Log.logException("Kết thúc lãnh địa gt lỗi (1)", Territory.class, e);
    ...
    public void close() {
        ...
        for (Char _char : members) {
            try {
                ...
                Log.logException("Đóng lãnh địa gt lỗi (1)", Territory.class, e);
        ...
        for (Zone z : this.zones) {
            ...
            if (tilemap.id == map) {
                try {
                    ...
                    Log.logException("Vào map lãnh địa gt lỗi (1)", Territory.class, e);
    ...
    public void addPointPB(int point) {
        ...
        for (Char _char : members) {
            try {
                ...
                Log.logException("Cộng điểm lãnh địa gt lỗi (1)", Territory.class, e);
