...
public class ItemTemplate {
    ...
    public static final int TYPE_NGOC_KHAM = 34; // thú cưỡi
    ...
    // fix vk 10x
    public boolean isVk100x() {
        return this.id == 1111 || this.id == 1112 || this.id == 1113 || this.id == 1114 || this.id == 1115 || this.id == 1116;
    }

    public boolean isTypeMartialArtBook() {
        if ((this.id >= 40 && this.id <= 93) || (this.id >= 311 && this.id <= 316) || (this.id >= 375 && this.id <= 380) || (this.id >= 547 && this.id <= 563)) {
            return true;
        }
        return false;
    }
    ...
    public boolean isItemLmitQuantity() {
        return this.id == ItemName.THE_BAI_KINH_NGHIEM_GIA_TOC_CAO
                || this.id == ItemName.THE_BAI_KINH_NGHIEM_GIA_TOC_SO
                || this.id == ItemName.THE_BAI_KINH_NGHIEM_GIA_TOC_TRUNG  ;
    }
    ...
    public boolean isTypeBijuu() {
        if (this.type == 10 && (this.id >= 994 && this.id <= 1047)) {
            return true;
        }
        return false;
    }
