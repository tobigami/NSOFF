...
public class GroupService extends AbsService {
    ...
    public void playerInParty() {
        try {
            ...
            sendMessage(ms);
             ...
             Log.logException("playerInParty err:" , GroupService.class, ex);
        }
    }
    ...
    public void changeLeader(int index) {
        try {
            ...
            sendMessage(ms);
             ...
             Log.logException("changeLeader err:" , GroupService.class, ex);
        }
    }
    ...
    public void chat(String name, String text) {
        try {
            ...
            mss.cleanup();
             ...
             Log.logException("chat err: " , GroupService.class, ex);
        }
    }
    ...
    public void lockParty(boolean isLock) {
        try {
            ...
            Log.logException("Có lỗi xảy ra tại:",GroupService.class,ex);
        }
    }
