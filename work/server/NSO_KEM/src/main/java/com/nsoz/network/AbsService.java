...
public abstract class AbsService {
    ...
    public Message messageNotLogin(int command) {
        try {
            ...
            return ms;
             ...
             Log.logException("Lỗi gửi message",AbsService.class,ex);
        }
        return null;
    }
    ...
    public void addEffectAuto(byte id, short x, short y, byte loop, short time) {
        try {
            ...
            ms.cleanup();
             ...
             Log.logException("add eff auto err: ",AbsService.class, ex);
        }
    }
    ...
    public void changePk(Char p) {
        try {
            ...
            ms.cleanup();
             ...
             Log.logException("change pk err: ", AbsService.class, ex);
        }
    }
    ...
    public void playerRemove(int id) {
        try {
            ...
            ms.cleanup();
             ...
             Log.logException("player remove err: " , AbsService.class, ex);
        }
    }
    ...
    public void loadCoat(Char _char) {
        try {
            ...
            Log.logException("Lỗi loadCoat: ", AbsService.class, ex);
    ...
    public void loadMount(Char _char) {
        try {
            ...
            Log.logException("Lỗi loadMount: ", AbsService.class, ex);
    ...
    public void charInfo(Message ms, Char _char) {
        try {
            ...
            for (int i = 0; i < 10; i++) {
             ...
             Log.logException("charInfo err: " , AbsService.class, e);
        }
    }
    ...
    public void onBijuuInfo(int playerID, Item[] arrItemViThu) {
        try {
            ...
            ms.cleanup();
             ...
             Log.logException("info bijuu err", AbsService.class,ex);
        }
    }
    ...
    public void onChangeBijuu(int playerID, Mob mob) {
        try {
            ...
            ms.cleanup();
             ...
             Log.logException("change bijuu err", AbsService.class,ex);
        }
    }
    ...
    public Message messageBijuu(int command) {
        try {
            ...
            return ms;
             ...
             Log.logException("write message sub comnand err", AbsService.class, ex);
        }
        return null;
    }
}
