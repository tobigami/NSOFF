...
public class StallManager implements Runnable {
    ...
    public void addItem(Char p, Item item, int price) {
        ...
        if (stall != null) {
            stall.add(item);
            DbManager.insertItemToStall(item);
        }
    }
    ...
    public void load() {
        ...
        try (Connection conn = DbManager.getConnection();
            ...
            Log.logException("Load data shinwa error:", StallManager.class,e);
        ...
        while (running) {
            ...
            if (l2 - l1 < 1000) {
                try {
                    ...
                    Log.logException("Update  Shinwa error:", StallManager.class,e);
