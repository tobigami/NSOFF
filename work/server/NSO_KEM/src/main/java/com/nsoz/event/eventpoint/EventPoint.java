...
public class EventPoint {
    ...
    public boolean setRewarded50k(String key, int reward) {
        Point p = find(key);
        if (p != null) {
            p.setRewarded50k(reward);
            return true;
        }
        return false;
    }
    public boolean setRewardedAll(String key, int reward) {
        Point p = find(key);
        if (p != null) {
            p.setRewardedAll(reward);
            return true;
        }
        return false;
    }
    ...
    public int getRewarded50k(String key) {
        Point p = find(key);
        if (p != null) {
            return p.getRewarded50k();
        }
        return -1;
    }
    public int getRewardedAll(String key) {
        Point p = find(key);
        if (p != null) {
            return p.getRewardedAll();
        }
        return -1;
    }
    ...
    public String toString() {
        ...
        // private String playerName;
        // private int playerID;
        String output = "id" + id + "playerName" + playerName + "playerID" + playerID;
        return output;
    }
}
