    ...
    public void setAbility(Char owner) {
        ...
        if (owner.bijuu[4] != null && (!owner.bijuu[4].isExpired())) {
            for (Item bijuu : owner.bijuu) {
                if (bijuu != null) {
                    for (ItemOption itemOption : bijuu.getOptions()) {
                        int optionId = itemOption.optionTemplate.id;
                        owner.options[optionId] += itemOption.param;
        ...
        owner.damage += owner.options[73] + owner.options[87] + owner.options[76];
        ...
        owner.miss += owner.options[5] + owner.options[17] + owner.options[62] + owner.options[68] + owner.options[78] + owner.options[84] + owner.options[115]
                + owner.optionsSupportSkill[13];
        owner.exactly += owner.options[10] + owner.options[18] + owner.options[75] + owner.options[86] + owner.options[116] + owner.optionsSupportSkill[12];
        owner.resFire = owner.options[2] + owner.options[11] + owner.options[33] + owner.options[70] + owner.options[96] + owner.optionsSupportSkill[19]
                + owner.optionsSupportSkill[20] + owner.options[36] + owner.options[118];
        owner.resIce = owner.options[3] + owner.options[12] + owner.options[34] + owner.options[71] + owner.options[95] + owner.optionsSupportSkill[19]
                + owner.optionsSupportSkill[21] + owner.options[36] + owner.options[118];
        owner.resWind = owner.options[4] + owner.options[13] + owner.options[35] + owner.options[72] + owner.options[97] + owner.optionsSupportSkill[19]
                + owner.optionsSupportSkill[22] + owner.options[36] + owner.options[118];
        owner.fatal = owner.options[14] + owner.options[37] + owner.options[69] + owner.options[92] + owner.options[114] + owner.optionsSupportSkill[14];
