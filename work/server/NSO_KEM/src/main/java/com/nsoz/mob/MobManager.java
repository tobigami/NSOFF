    ...
    public boolean load() {
        ...
        try (Connection conn = DbManager.getConnection();
            ...
            while (resultSet.next()) {
                try {
                    ...
                    for (int i = 0; i < size; i++) {
                        ...
                        img.x = ((Long) job.get("x")).intValue();
                        img.y = ((Long) job.get("y")).intValue();
                    ...
                    pb.reportError();
                    Log.logException("Lỗi load mob  : ", MobManager.class, e);
            ...
            pb.reportSuccess();
             ...
             Log.logException("load mob err", MobManager.class, e);
            return false;
        }
        return true;
    }
