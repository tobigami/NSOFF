...
public class Clan {
    ...
    public int pointWarWeek; /// t7 đen tối
    public int topWarWeek; /// t7 đen tối
    public Clan() {
                    ...
                    if (l2 - l1 < 1000) {
                        try {
                            Thread.sleep(1000 - (l2 - l1));
                             ...
                             Log.logException("clan update err", Clan.class,ex);
                        }
                    }
                }
            }
            ...
            for (Clan clan : clans) {
                try {
                    clan.update();
                     ...
                     Log.logException("update err 1" , Clan.class,e);
                }
            }
        }
    }
    ...
    public void setOpenGtc(byte openDun) {
        this.openGtc = openDun;
    }
    ...
    public void addPoint(int point) { /// t7 đen tối
        this.pointWarWeek += point;
    }
}
