...
public class EffectAutoDataManager {
    ...
    public static final int CAY_THONG = 13;
    public static final int CAY_MAI = 14;
    public static final int CAY_DAO = 15;
           ...
           try{
               while (resultSet.next()) {
                   ...
                   for (int i = 0; i < lent1; i++) {
                       ...
                       imgInfo[i].x = info.getInt("x");
                       imgInfo[i].y = info.getInt("y");
             ...
             Log.logException("load effect auto err" , EffectAutoDataManager.class, e);
        }finally {
